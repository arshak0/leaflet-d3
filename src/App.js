      ...
      <div className="all_charts">
        ...
        <div className="chart_row">
          <div className="arrow_chart">
            ...
            <div className="arrow_charts">
              <FuelChart fuel_array={count_for_fuel} sensorId="1"/> 
              <FuelChart fuel_array={count_for_fuel} sensorId="2"/>
              <FuelChart fuel_array={count_for_fuel} sensorId="3"/>
              <FuelChart fuel_array={count_for_fuel} sensorId="4"/>
              <FuelChart fuel_array={count_for_fuel} sensorId="5"/> 
              <FuelChart fuel_array={count_for_fuel} sensorId="6"/>
              <FuelChart fuel_array={count_for_fuel} sensorId="7"/>
              <FuelChart fuel_array={count_for_fuel} sensorId="8"/> 
              <FuelChart fuel_array={count_for_fuel} sensorId="9"/>
              <FuelChart fuel_array={count_for_fuel} sensorId="10"/>
            </div>
          </div>
        </div>
